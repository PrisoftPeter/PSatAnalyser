...
public class K41b extends World implements Serializable {
	...
	public K41b(Agent self, Agent agent1, Agent agent2, Attribute attribute){
		this.self = self;
		this.agent1 = agent1;
		this.agent2 = agent2;
		...
		super.type = "K41b";
		super.htmlType = "<i>k</i><sub>41b</sub>";
