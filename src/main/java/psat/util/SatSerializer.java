...
//			protocolHtmlFullDesc = protocolHtmlFullDesc+desc;
	...
	public void displayReq(InformationFlows ifs, ConfigInstance instance){
...
//												  + "</table>";
		...
		Display.updateLogPage(req, false);
...
//				+ "<td bgcolor='white' WIDTH=708>"+protocolHtmlFullDesc+"</td></tr>"
		...
		Display.updateLogPage(satresultHtml, false);
	...
	public void displaySat(String path, String subjectName, String senderName, String recipientName, 
		...
		if(PSatAPI.instance.isModeEntropy){
			ptr_row.setRequirementHtmlFullDesc("<html><body>"+PSatAPI.instance.desiredEntropyDesc+"</body></html>");
		}
