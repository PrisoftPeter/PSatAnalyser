...
import psat.knowledge.worlds.K0aDepreciated;
import psat.knowledge.worlds.K1a;
import psat.knowledge.worlds.K21a;
import psat.knowledge.worlds.K31a;
import psat.knowledge.worlds.K41a;
import psat.knowledge.worlds.K42a;
...
public class CGK0aVerifierDepreciated {
	...
	public static double verify(Agent subject, Agent sender, Agent recipient, Attribute message,ArrayList<Agent> agentsInPath){
