...
//           		});
           		...
           		String [] memoryStorePaths = PSatAPI.netGetMemoryStorePaths(pickV.id);
...
//        								Display.selfAgentName = pickV.id;
                						...
                						MemoryFactory.dumpMemoryStoreOnDisplay(pickV.id, storePath, -10);		
...
//           		JMenu paMenu = new JMenu("privacy requirements");
       			...
       			goalMenu.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e) {
						Agent selectedAgent = PSatAPI.netGetAgent(pickV.id);
						if(selectedAgent !=null){
							...
							if(ok){
								...
								PSatAPI.netWriteAgent(selectedAgent);
								PSatAPI.netSerialiseConfigInstance();
							}
							else{
        		...
        		ImageIcon roleIcon = new ImageIcon(getClass().getResource("/role.png"));
           		...
           		rolesMenu.addActionListener(new ActionListener(){
					public void actionPerformed(ActionEvent e) {
						...
						PSatAPI.netPrivacyRequirementRoles(pickV.id);
...
//           		popup.add(targetMenu);
           		...
           		if(PSatAPI.instance.sourceAgentName !=null){
	        		//for(Object ename:Display.selectedAgentPath){
           			for(String ename:PSatAPI.netGetAgentNames()){
